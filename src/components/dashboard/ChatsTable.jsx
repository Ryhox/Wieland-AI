    ...
    <div className="db-table-section">
                ...
                >
                  ...
                  <td onClick={(e) => e.stopPropagation()}>
                    <div
                      ...
                      onClick={() =>
                        onUserClick({ username: c.username, id: c.user_id })
                      }
                    ...
                    >
                      ...
                      <span className="db-user-link">
                        {c.username ?? `#${c.user_id}`}
                      </span>
                    </div>
                  </td>
                  <td onClick={(e) => e.stopPropagation()}>
                    <span className="db-msg-count-badge">
                      {c.message_count ?? 0}
                    </span>
                  </td>
      ...
      <div className="db-table-footer">
        <span className="db-table-count">
          {t("dashboard.table.totalChats", { count: total })}
        </span>
        <Pagination
          page={page}
          total={total}
